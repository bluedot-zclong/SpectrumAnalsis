            ...
            <div class="nest" id="Blank_PageClose">
                ...
                <div class="body-nest" id="Blank_Page_Content">
					...
					<thead>
					  <!-- On rows -->
					    <tr>
					   		<th class="text-center"><strong>内容名称</strong></th>
							<th class="text-center"><strong>含量</strong></th>
						</tr>
					</thead>
						<tbody>
							...
							<#list report.map ? keys as key>
								<tr>
									<td class="active text-center">${key}</td>
									<td class="active text-center">${report.map["${key}"]}</td>
								</tr>
							</#list>
